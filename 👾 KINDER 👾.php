<?php
//=========التوكن=========//
$token = "6860008676:AAE4ub0IZjNLNngxpIjqg7AHLxy7ZGFBgOY"; 
...
#############
$eri = array("$admin","6782361518");
$idbot = "6860008676";
$sudo = "$admin";
$buy = "A_R_B_Y";
$Dev = array("$admin","6782361518");
$admin = "6782361518";
$DevUser = "@$buy";
$devchink = "V_V_X_1";
$userbot = "MIDO_99_bot";
...
'keyboard'=>[
[['text'=>"『 𝑆 𝑂 𝑈 𝑅 𝐶 𝐸 』",'url'=>"t.me/V_V_X_1"]],
[['text'=>"『 𝐾 𝐼 𝑁 𝐷 𝐸 𝑅 』",'url'=>"t.me/DEVKINDER"]],
[['text'=>"『 𝒃 𝑂 𝑇 』",'url'=>"t.me/MIDO_99_BOT"]],
[['text'=>"『 𝐺 𝑅 𝑂 𝑈 𝑃 』",'url'=>"t.me/V_V_X_2"]],
],
])
]);
}
}
#===== S O U R C E = K I N D E R =====#
if($text == "السورس" or $text == "سورس" or $text == "يا سورس" or $text == "سورس كيندر" and $sorceu == null){
bot('sendmessage',
'chat_id'=>$chat_id;
'text'=>"
╭────── • ◈ • ──────╮
么『 𝑆 𝑂 𝑈 𝑅 𝐶 𝐸 』(https://t.me/V_V_X_1)
么 『 𝐾 𝐼 𝑁 𝐷 𝐸 𝑅 』(https://t.me/DEVKINDER)
╰────── • ◈ • ──────╯
...
/\*====RAD==SOURCE====*/\
if($text == "السورس" or $text == "سورس" or $text == "يا سورس" or $text == "سورس كيندر" and $sorceu == null){
if($from_id==$eri or in_array($from_id,$eri)){
bot('sendmessage',
'chat_id'=>$chat_id;
'text'=>"
يـسـطـا نـت الـسـورس اقـسـم بالله ⁦👩‍💻⁩ ."
...
⋄︙ [تحديثات السورس الجديده](https://t.me/V_V_X_1)",
'parse_mode'=>"markdown",
'disable_web_page_preview'=>true,
'reply_to_message_id'=>$message->message_id,
'reply_markup'=>json_encode([
...
if($text == "تفعيل" or $text == "حظر" or $text == "ايدي" or $text == "كتم" or $text == "تقيد" or $text == "الاوامر" or $text == "ا" or $text == "الاعدادات" or $text == "رتبنتي" or $text == "كشف" or $text == "الرتبه" or $text == "رتبته" or $text == "اضف رد" or $text == "حذف رد" or $text == "تاك" or $text == "حذف امر" or $text == "اضف امر" or $text == "تاك للكل" or $text == "/start" or $text == "/kinder")
if($message && (strpos($ch2,'"status":"left"') or strpos($ch2,'"Bad Request: USER_ID_INVALID"') or strpos($ch2,'"status":"kicked"'))!== false){
bot('sendMessage', [
'chat_id'=>$chat_id,
'text'=>'
⌔︙عذرا عزيزي 「 [$first_name](tg://user?id=$from_id) 」 ⚠️.
...
if($text == "تفعيل" or $text == "حظر" or $text == "ايدي" or $text == "كتم" or $text == "تقيد" or $text == "الاوامر" or $text == "الاعدادات" or $text == "رتبنتي" or $text == "كشف" or $text == "الرتبه" or $text == "رتبته" or $text == "اضف رد" or $text == "حذف رد" or $text == "تاك" or $text == "حذف امر" or $text == "اضف امر" or $text == "تاك للكل" or $text == "/start"){
...
if($from_id==$eri or in_array($from_id,$eri)){
bot('sendMessage',["
- صـاحـب الـسـورس بـنفـسـو ؟ 🤯

نـورت ي غـالـي اقـسـم بالله 🙈💕
";
/*===== dev ~ @DEVKINDER =====*/
@$settings = json_decode(file_get_contents("data/$chat_id.json"),true);
@$settings = json_decode(file_get_contents("data/$chat_id.json"),true);
...
if(in_array($from_id,$nazar)) {
	...
	$mdrs1 = explode("             \n",$mdrs);
	$str = str_replace($re_id,"",$re_id_info);
	$str2 = str_replace(" *𓆩* [" . "@". $re_user ."] *𓆪* " . "»" . " *??* `". $re_id ."` *??* ","",$mdrs1);
	file_put_contents("data/manger/$chat_id.txt",$str);
	file_put_contents("data/manger/$chat_id/mange.txt",$str2);
	$re_id_info = file_get_contents("data/admin_user/$chat_id.txt");
	$admn = file_get_contents("data/admin_user/$chat_id/mange.txt");
...
if ( $text =="تفعيل ردود كيندر" or $text == "تفعيل ردود البوت" or $text == "تفعيل ردود السورس"){
if ( $status == 'creator' or $status == 'administrator' or in_array($from_id,$Dev) or in_array($from_id,$manger) or in_array($from_id,$admin_user) or in_array($from_id,$developer) or in_array($from_id,$carlos) or in_array($from_id,$eri) or in_array($from_id,$AUBEHAB) or in_array($from_id,$nazar)) {$add = $settings["information"]["added"];
if ($add == true) {
bot('sendmessage',[
'chat_id'=>$chat_id,
...
if ( $text =="تعطيل ردود كيندر" or $text =="تعطيل ردود البوت" or $text =="تعطيل ردود السورس"){
if ( $status == 'creator' or $status == 'administrator' or in_array($from_id,$Dev) or in_array($from_id,$manger) or in_array($from_id,$admin_user) or in_array($from_id,$developer) or in_array($from_id,$nazar) or in_array($from_id,$carlos) or in_array($from_id,$AUBEHAB) or in_array($from_id,$eri)) {$add = $settings["information"]["added"];
if ($add == true) {
bot('sendmessage',[
'chat_id'=>$chat_id,
...
file_put_contents("data/namebot.txt","كيندر");
...
$botproxre = array(
"لك انته البوت",
"ياخي وربي اسمي كيندر",
"ي قلبي حرام عليك اسمي كيندررر",
"اسمي كيندر حياتي"
);
$reproxbot = array_rand($botproxre, 1);
if($text == "بوت" || $text == "البوت اسمو ايه" || $text == "اسم البوت" || $text == "البوت اسمه" || $text == "ايه اسم البوت" and $namebot == NULL){
if ($tc == 'group' | $tc == 'supergroup'){
...
$namere = array(
"اهلا ي روحي انا $namebot",
"تفضل حبيبي انا $namebot🌝💞",
"معاك ي عمري آمرني 🥺💞",
"عايز ايه كل شويه $namebot",
"يلهوي كل شويه $namebot قرفتوني"
);
...
$abuehab = array("اهلا ي روحي انا كيندر","تفضل حبيبي انا كيندر🌝💞","معاك ي عمري آمرني 🥺💞","عايز ايه كل شويه كيندر","يلهوي كل شويه كيندرر كيندرر قرفتوني");
$ehab = array_rand($proxre, 1);
if($text == "كيندر" and $namebot == NULL){
if ($tc == 'group' | $tc == 'supergroup'){
...
⋄︙حسنأ قم بأرسال معرف قناة من غير @
",'parse_mode'=>"MARKDOWN",'reply_to_message_id'=>$message_id,]);}
...
"text" => "
⋄︙حسننا عزيزي المطور،
⋄︙ تم حفظ  كليشة المطور الخاصه بيك
 ",'parse_mode'=>"MARKDOWN",
 'reply_to_message_id'=>$message_id
,]);}
...
[['text'=>'✵⁞ ثلاثه ⁞✵' ,'callback_data'=>"mai6"]],
[['text'=>'✵⁞ اثنين ⁞✵' ,'callback_data'=>"nb"]],
[['text'=>'✵⁞ الغاء ⁞✵' ,'callback_data'=>"deletmil"]],
]])
]); 
}
...
[['text'=>'⋄ الغاء ⋄' ,'callback_data'=>"deletmil"]],
[['text'=>"⋄ قناة السورس ⋄",'url'=>"t.me/V_V_X_1"]],
]])
]); 
}
}
...
$like = array("يخي وربي قمر ☹️❤️","لا بس ايه الحلاوه ديي ،₍🍯😻⁾","ي اهلا بلعسل😍","م مرتاحلك 🙂😐","تحبني؟🙈","ي عمريي🌚😹","كيكك والله🥺","خره والله☹️","قمر و نسينو ف الجروب😟","نت لازق فيها غيرها بق😒");
...
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"ممكن تقولنا ايه احساسك دلوقتي 😂😂",
'reply_to_message_id'=>$message->message_id, 
]);
}}
if($text == "😉"){
...
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>" بخيࢪ ي قلبي طول ما انـته بخيࢪ💘🙊",
'reply_to_message_id'=>$message->message_id, 
]);
}}
if($text == "عامل ايه"){
...
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"يدوم وكعد ع عناد الواكفين 🤷🏼‍♀️😂",
'reply_to_message_id'=>$message->message_id, 
]);
}}
if($text == "يدومج"){
...
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"عيب ابني/بنتي تفهه اكبر منها شوية 😌😹",
'reply_to_message_id'=>$message->message_id, 
]);
}}
if($text == "تخليني"){
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"⋄︙اوامر الحمايه لسورس كيندر
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
⋄︙قفل ، فتح ← الامر 
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"⋄︙اوامر الاعضاء لسورس كيندر
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
...
$boscra = array("مواححح افيـش عافيههه😍🔥💗","امممووااهحح اي العسل دهه 😂⁦❤️⁩🥺🍯💘","مواححح،ءوفف اذوب🤤💗");
...
$henacar = array("لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","هحاول احترمك المره دي بس نت هتفضل حيوان، 🤔🔪");
$henacar2 = array_rand($henacar, 1);
if($rt and !in_array($re_id,$Dev) and !in_array($re_id,$eri)){
if($text == "اشتمه" or $text == "بعد اشتمه" or $text == "اشتمه بعد" or $text == "اشتمها" or $text == "اشتمهه" or $text == "رزله" or $text == "رزلها" or $text == "رزلهه"){
bot('sendMessage',[ 'chat_id'=>$chat_id, 'text'=>"صارر ستاذيي 🏃🏻‍♂️♥️", 'reply_to_message_id'=>$message->message_id, ]);
...
if($rt and in_array($re_id,$Dev) and in_array($re_id,$eri)){
if($text == "اشتمه" or $text == "بعد اشتمه" or $text == "اشتمه بعد" or $text == "اشتمها" or $text == "اشتمهه" or $text == "رزله" or $text == "رزلها" or $text == "رزلهه"){
bot('sendMessage',[ 'chat_id'=>$chat_id, 'text'=>"دا لا يكسمك عاوزني انيكك ولا اييك؟😏🖕🏿",'parse_mode'=>"MARKDOWN", 'reply_to_message_id'=>$message->reply_to_message->message_id ]);}}
...
$admn1 = explode(" \n",$admn);
$str = str_replace($from_id,"",$from_id_info);
$str2 = str_replace(" *??* [" . "@". $username ."] *𓆪* " . "»" . " *𓆩* `". $from_id ."` *𓆪* ","",$admn1);
file_put_contents("data/admin_user/$chat_id.txt",$str);
file_put_contents("data/admin_user/$chat_id/mange.txt",$str2);
...
$chat_id     = $message->chat->id;
$user          = $update->message->from->username;
$sudo         = $sudo; // 6782361518
$bot_id       = $iidd; // 6860008676
$from_id     = $message->from->id;
$first_name = $message->from->first_name;
...
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[[['text'=>"- CaRloS .",'url'=>"t.me/V_V_X_1"]],]])]);}}
#┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
$re = $update->message->reply_to_message;
...
⋄︙[تفاصيل الملف](https://t.me/V_V_X_1/2)
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
 ]);
...
if ($add == true) {
 ...
 'text'=>"⋄︙الملف ⋙ *Zhrafa*
⋄︙تم تفعيله في البوت بنجاح
⋄︙[تفاصيل الملف](https://t.me/V_V_X_1/3)
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
 ]);
...
⋄︙تم تفعيله في البوت بنجاح
⋄︙[تفاصيل الملف](https://t.me/V_V_X_1/4)
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
 ]);
...
⋄︙تم تفعيله في البوت بنجاح
⋄︙[تفاصيل الملف](https://t.me/V_V_X_1/5)
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
 ]);
...
⋄︙تم تفعيله في البوت بنجاح
⋄︙[تفاصيل الملف](https://t.me/V_V_X_1/7)
",'parse_mode'=>"markdown",'disable_web_page_preview'=>true,
  'reply_to_message_id'=>$message_id,
'reply_markup'=>$inlinebutton,
 ]);
...
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"⋄︙قائمة ملفات متجر سورس كيندر
⋄︙الملفات المتوفره حاليا ↫ ⤈
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
⋄︙[ملف العاب اونلاين](https://t.me/V_V_X_1/3) ↫ ⤈
1~ : game ↬ ($gamejson)
⋄︙[ملف زخرفه](https://t.me/V_V_X_1/4) ↫ ⤈
2~ : Zhrafa ↬ ($Zhrafajson)
⋄︙[ملف تنبيه عند تغير الاسم](https://t.me/V_V_X_1/5) ↫ ⤈
3~ : ChangeName ↬ ($ChangeName)
⋄︙[ملف تنبيه عند تغير المعرف](https://t.me/V_V_X_1/6) ↫ ⤈
4~ : ChangeUser ↬ ($ChangeUser)
⋄︙[ملف تنبيه عند تغير الصورة](https://t.me/V_V_X_1/7) ↫ ⤈
...
'chat_id'=>$chat_id,
'text'=>"
⋄︙المنشئ ⋙ {[$owner1](tg://user?id=$owner)}
⋄︙ايدي المنشئ ⋙ {$owner}
⋄︙معرف المنشئ ⋙ {@$owner2}
",
'reply_to_message_id'=>$message_id,'parse_mode'=>"MarkDown",
...
'text'=>"
⋄︙اليك اوامر الترجمه 
⋄︙العربيه الي الانجليزيه ~⪼ ar#en
⋄︙الانجليزيه الي العربيه ~⪼ en#ar
⋄︙العربيه الي الفارسيه ~⪼ fr#ar
⋄︙الفارسيه الي العربيه ~⪼ ar#fr
⋄︙التركيه الي العربيه ~⪼ ar#tr
⋄︙ العربيه الي التركيه ~⪼ tr#ar
⋄︙لانجليزيه الي التركيه ~⪼ tr#en
⋄︙التركيه الي الانجليزيه ~⪼ en#tr
⋄︙قم بنسخ اوامر الذي فوق 
⋄︙وقم بالرد علي الكلمة المطلوبة
",
'reply_to_message_id'=>$message_id,'parse_mode'=>"MarkDown",
]);
}
...
########
if($text == "⋄ تجربة السورس"){if(in_array($from_id,$Dev) or in_array($from_id,$eri)) {bot("sendmessage",['chat_id'=>$chat_id,'text'=>"✵⁞ *اليك قائمة تجربة السورس*\n━━━━━━━━━━━━━\n⌯⁞ [جروب تجربة السورس](https://t.me/V_V_X_2)\n⌯⁞ [قناة شروحات السورس](https://t.me/V_V_X_1)\n━━━━━━━━━━━━━\n⌯⁞ [مطور السورس](https://t.me/DEVKINDER)",'parse_mode'=>"Markdown",'disable_web_page_preview'=> true ,'reply_to_message_id'=>$message_id,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text'=>"⌯⁞ جروب تجربة السورس ⁞⌯",'url'=>"t.me/V_V_X_2"]],[['text'=>"⌯⁞ مطور السورس ⁞⌯",'url'=>"t.me/$buy"]],]])]);}}
#######
...
⋄︙تغير الايدي ↫ تغ
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
[Source KINDER](https://t.me/V_V_X_1)",
'parse_mode'=>"markdown",'reply_to_message_id'=>$message_id,
 ]);
 } 
 #---------------#
...
echo "source Kinder";
/\*======T=H=E===E=N=D======*/\
هـذا الـمـلـف مـلـك لـلـمـطـور مـيـدو كـيـنـدر 👨🏿‍💻
⚠️ تـحـذيـر هـام » هـذا الـمـلـف غـيـر قـابـل لـلـتـعـديـل  ⚠️
• لـلـتـنـصـيـب يـرجـي زيـارة قـنـاة الـسـوس •
>>>(@V_V_X_1)<<<
